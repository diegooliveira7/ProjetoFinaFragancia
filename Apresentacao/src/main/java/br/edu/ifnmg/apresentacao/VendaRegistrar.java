 ...
 * @author diego
 */
public class VendaRegistrar extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form VendaRegistrar
     */
    public VendaRegistrar() {
        initComponents();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if(!this.txtCliente.getText().isEmpty() && this.transacao.getItens().size() > 0){
            Pessoa pessoa = repositorioPessoa.Abrir(Long.valueOf(this.txtCliente.getText()));
            if(pessoa != null){
                if(JOptionPane.showConfirmDialog(this, "Deseja Realmente Salvar?", "Confirma", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_NO_OPTION){
                    ...
                    this.transacao.setTipo(TransacaoTipo.Venda);
                    ...
                    if(this.repositorioTransacao.Salvar(this.transacao)){
                        for(TransacaoItem item : this.transacao.getItens()){
                            ...
                            produto.setEstoqueT(item.getQuantidade(), 2);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!this.txtProduto.getText().isEmpty() && !this.txtQuantidade.getText().isEmpty()){
            try{
                ...
                if(produto.getEstoque() >= Integer.valueOf(this.txtQuantidade.getText())){
                    if(produto != null){
                        ...
                        JOptionPane.showMessageDialog(null, "Produto não existe!", "Information", JOptionPane.INFORMATION_MESSAGE);
                    }
                }else{
                    JOptionPane.showMessageDialog(null, "Quantidade em estoque infuficiente para a quantidade desejada!", "Information", JOptionPane.ERROR_MESSAGE);
                }
            }catch(Exception ex){
